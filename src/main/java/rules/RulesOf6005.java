...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if (writtenByYourself) {
            System.out.println("The Code is Written by yourself");
            ret = true;
        } else {
            System.out.println("The Code is Not Written by yourself");

            if (availableToOthers) {
                System.out.println("The Code is Available to others");
            } else {
                System.out.println("The Code is Not Available to others");
                ret = false;
            }

            if (writtenAsCourseWork) {
                System.out.println("The Code is Written as Course Work");
            } else {
                System.out.println("The Code is Not Written as Course Work");
                ret = false;
            }
        }

        if (citingYourSource) {
            System.out.println("The Code is Properly Cited Its Source");
        } else {
            System.out.println("The Code is Not Properly Cited Its Source");
            ret = false;
        }

        if (implementationRequired) {
            System.out.println("The Code is Implementation Required");
        } else {
            System.out.println("The Code is Not Implementation Required");
            ret = false;
        }
